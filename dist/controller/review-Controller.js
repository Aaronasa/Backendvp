...
class ReviewController {
    ...
    static readReviewsByRestaurant(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const restaurantId = review_validation_1.ReviewValidation.READ.parse({ restaurantId: parseInt(req.params.restaurantId, 10) }); // Validate restaurantId
    ...
    static deleteReview(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const request = review_validation_1.ReviewValidation.DELETE.parse(req.body); // Validate and parse the input
